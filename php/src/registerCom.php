...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt->execute();
    $stmt->bind_result($company_count);
    $stmt->fetch();

    if ($company_count > 0) {
        echo "<script>
        alert('Company name is already in use. Please try another name.');
        window.history.back();
    </script>";
        exit();
    }
    ...
    <div class="max-w-lg mx-auto mt-12 bg-white p-6 rounded-lg shadow-lg">
        ...
        <form action="registerCom.php" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="subdistrict" id="district"
                    class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="district" id="amphoe"
                    class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="postal_code" id="zipcode"
                    class="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required>
            </div>
