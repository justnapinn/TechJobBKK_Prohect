...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if ($update_stmt->execute()) {
        // หากอัปเดตสำเร็จ แสดงข้อความแจ้งเตือนด้วย JavaScript
        echo "<script>alert('Status updated to: " . htmlspecialchars($new_status) . "');</script>";
    } else {
        // หากเกิดข้อผิดพลาด แสดงข้อความแจ้งเตือนด้วย JavaScript
